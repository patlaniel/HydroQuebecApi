...
namespace HydroQuebecApi.Models
{
    public class DailyData
    {
        ...
        [JsonPropertyName("consoRegQuot")] public double RegularPriceConsumption { get; set; }
        [JsonPropertyName("consoHautQuot")] public double HighPriceConsumption { get; set; }
        [JsonPropertyName("consoTotalQuot")] public double TotalConsumption { get; set; }
        [JsonPropertyName("codeConsoQuot")] public string ConsumptionCode { get; set; }
        [JsonPropertyName("tempMoyenneQuot")] public int AverageTemperature { get; set; }
